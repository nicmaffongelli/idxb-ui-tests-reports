...
```yaml
- text: You have entered an invalid Email or Password. An email address is required to access your account(s). For more information about this change,
- link "please see this article.":
  - /url: https://support.idxbroker.com/s/article/Having-Trouble-Logging-In
- textbox "Email": idxbqatest+20250705prod@gmail.com
- textbox "Password": qwe123!@#
- paragraph:
