...
- Name: Type of user: Client >> MW Menu: Design >> Sub-menu: Website >> Enable Request Registration at page level and validate it on the FE page - User: Client-Engage-1-Existing
