...
Call log:
  - waiting for locator('#select2-IDX-pt-container')

    at FrontEndAdvancedSearchPage.clickPropertyTypeDropdown (/opt/atlassian/pipelines/agent/build/tests/pages/client/frontEndPages/FrontEndAdvancedSearchPage.ts:138:41)
    at /opt/atlassian/pipelines/agent/build/tests/specs/clients/design/settings/mls/propertyTypeMlsSettings.spec.ts:46:65
```
...
```ts
   38 |     // Beds and Baths elements
   39 |     readonly bedroomsDropdown: Locator;
   40 |     readonly bathroomsDropdown: Locator;
   41 |     
   42 |     // Additional filters
   43 |     readonly sqftDropdown: Locator;
   44 |     readonly acresDropdown: Locator;
   45 |     readonly priceReductionDropdown: Locator;
   46 |     readonly statusDropdown: Locator;
   47 |     readonly searchRefinementDropdown: Locator;
   48 |     readonly resultsPerPageDropdown: Locator;
   49 |     readonly sortByDropdown: Locator;
   50 |     
   51 |     // Action buttons
   52 |     readonly searchButton: Locator;
   53 |     
   54 |     /**
   55 |      * Constructor for FrontEndAdvancedSearchPage
