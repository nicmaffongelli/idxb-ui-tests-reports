...
- Name: User: Client-Elite-1-Existing >> Client can perform a search in Advanced Search FE page and the number of results is 25 - User: Client-Elite-1-Existing
- Location: /opt/atlassian/pipelines/agent/build/src/tests/specs/clients/06_design/04_settings/01_global/resultsGlobalPreferences.spec.ts:28:13
...
Call log:
  - navigating to "https://testing1210elite.idxstaging.com/idx/search/advanced", waiting until "load"
    ...
    at /opt/atlassian/pipelines/agent/build/src/tests/specs/clients/06_design/04_settings/01_global/resultsGlobalPreferences.spec.ts:29:53
```
