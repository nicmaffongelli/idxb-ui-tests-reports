...
Call log:
  - waiting for locator('#newClientID') to be visible
    44 × locator resolved to hidden <span id="newClientID"></span>

    at CreateClientPage.getNewClientId (/opt/atlassian/pipelines/agent/build/tests/pages/superUser/clients/createClient.ts:387:25)
    at CreateClientPage.createClient (/opt/atlassian/pipelines/agent/build/tests/pages/superUser/clients/createClient.ts:502:27)
...
- group "Account Information":
  ...
  - radio "No" [checked]
  - text: "No"
  - checkbox "Apply $150 Setup Fee" [checked]
  - text: Apply $150 Setup Fee Primary Contact Information Client First Name*
  - textbox "Client First Name*"
  - text: Client Last Name*
  - textbox "Client Last Name*"
  - text: Brokerage Name*
  - textbox "Brokerage Name*"
  - text: Display Name*
  ...
  - button "Create"
  - button "Reset"
- 'heading "Client account creation: Success!" [level=2]'
- text: "The new client has been created with ID: . Use the links below for further setup."
- list:
  - listitem:
    - link "Manage this client's account.":
      - /url: /mgmt/clients/null/edit
  - listitem:
    - link "Manage this client's billing.":
      - /url: /mgmt/clients/null/billing
  - listitem:
    - link "Manage this client's MLS Membership.":
      - /url: /mgmt/clients/null/mls-membership
  - listitem:
    - link "Manage this client's contacts.":
      - /url: /mgmt/clients/null/contacts
  - listitem:
    - link "Enter another new client.":
      - /url: /mgmt/clients/create
- paragraph:
  - text: Services © 2025
  - link "IDX Broker":
...
> 387 |         await this.page.waitForSelector('#newClientID', { state: 'visible' });
  ...
  473 |             multiUser: clientInfo.multiUser,
  474 |             demoAccount: clientInfo.demoAccount,
  475 |             applySetupFee: clientInfo.applySetupFee
  476 |         });
  477 |         
  478 |         // Fill Primary Contact Information
  479 |         await this.fillPrimaryContactInformation({
  480 |             firstName: clientInfo.firstName,
  481 |             lastName: clientInfo.lastName,
  482 |             companyName: clientInfo.companyName,
  483 |             displayName: clientInfo.displayName,
  484 |             address: clientInfo.address,
  485 |             city: clientInfo.city,
  486 |             stateProvince: clientInfo.stateProvince,
  487 |             zipCode: clientInfo.zipCode,
```