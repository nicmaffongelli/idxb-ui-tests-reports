...
Locator: locator('tr:has(td:text-is("idxqamv+1749138776524@gmail.com"))')
Expected: visible
Received: <element(s) not found>
Call log:
  - expect.toBeVisible with timeout 20000ms
  - waiting for locator('tr:has(td:text-is("idxqamv+1749138776524@gmail.com"))')
...
- grid:
  ...
  - combobox "Show entries":
    ...
    - option "100"
  - text: "entries Search:"
  - 'textbox "Search: ? "': idxqamv+1749138776524@gmail.com
  - link "?":
    - /url: "#"
  - link "":
    - /url: "#"
