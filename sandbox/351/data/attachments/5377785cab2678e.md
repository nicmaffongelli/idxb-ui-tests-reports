...
- Name: User: Client-Engage-1-Existing >> Save Other Settings - User: Client-Engage-1-Existing
- Location: /opt/atlassian/pipelines/agent/build/src/tests/specs/clients/06_design/04_settings/01_global/globalPreferences.spec.ts:59:13
...
Call log:
  - waiting for getByRole('link', { name: 'Other' })

    at GlobalPreferencesPage.navigateToOtherTab (/opt/atlassian/pipelines/agent/build/src/page-objects/client/06_design/04_settings/01_global/GlobalPreferencesPage.ts:113:29)
    at /opt/atlassian/pipelines/agent/build/src/tests/specs/clients/06_design/04_settings/01_global/globalPreferences.spec.ts:61:48
```
