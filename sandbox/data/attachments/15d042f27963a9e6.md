...
- Name: User: Client-Engage-1-Existing >> Save Mobile Settings - User: Client-Engage-1-Existing
- Location: /opt/atlassian/pipelines/agent/build/src/tests/specs/clients/06_design/04_settings/01_global/globalPreferences.spec.ts:53:13
...
Call log:
  - waiting for getByRole('link', { name: 'Mobile' })

    at GlobalPreferencesPage.navigateToMobileTab (/opt/atlassian/pipelines/agent/build/src/page-objects/client/06_design/04_settings/01_global/GlobalPreferencesPage.ts:106:30)
    at /opt/atlassian/pipelines/agent/build/src/tests/specs/clients/06_design/04_settings/01_global/globalPreferences.spec.ts:55:48
```
