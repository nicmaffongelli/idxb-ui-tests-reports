...
- Name: Authenticate SuperUser user and create a new client >> Authenticate SuperUser user
- Location: /opt/atlassian/pipelines/agent/build/src/tests/setup-tests/superUser.setup.ts:17:10
...
Call log:
  - navigating to "https://middleware.idxbroker.com/mgmt/dashboard", waiting until "load"

    at LoginPage.goto (/opt/atlassian/pipelines/agent/build/src/page-objects/login/LoginPage.ts:19:21)
    at LoginPage.gotoLoginPageAndLoginWithCredentialsAndSaveStorageState (/opt/atlassian/pipelines/agent/build/src/page-objects/login/LoginPage.ts:36:16)
    at /opt/atlassian/pipelines/agent/build/src/tests/setup-tests/superUser.setup.ts:23:25
```
