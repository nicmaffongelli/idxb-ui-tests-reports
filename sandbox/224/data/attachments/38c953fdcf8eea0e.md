...
Error: expect(Buffer).toMatchSnapshot(expected)
  ...
  150726 pixels (ratio 0.17 of all image pixels) are different.
...
Received: /opt/atlassian/pipelines/agent/build/test-results/specs-clients-design-brand-0bb3d-ch-page---Client-engage-new-Chrome/sandbox-advanced-search-actual.png
    Diff: /opt/atlassian/pipelines/agent/build/test-results/specs-clients-design-brand-0bb3d-ch-page---Client-engage-new-Chrome/sandbox-advanced-search-diff.png
...
- navigation:
  - link "Advanced Search":
    - /url: https://qatest1746475973350.idxsandbox.com/idx/search/advanced
  - link "Listing ID":
    - /url: https://qatest1746475973350.idxsandbox.com/idx/search/listingid
  - link "Address":
    - /url: https://qatest1746475973350.idxsandbox.com/idx/search/address
  - link "AI Smart Search":
    - /url: https://qatest1746475973350.idxsandbox.com/idx/search/smart
  - link "Map Search":
    - /url: https://qatest1746475973350.idxsandbox.com/idx/map/mapsearch
  - separator
- text: Location
- textbox "Location"
- combobox:
