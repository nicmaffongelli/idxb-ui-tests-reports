...
Call log:
  - waiting for locator('.select2-container--open .select2-results__options[role="listbox"]').getByRole('option', { name: 'MLS Display 2025-05-02 23:36:06' })
...
- article:
  ...
  - combobox "Regional Multiple Listing Service" [expanded]:
    ...
    - tree:
      - treeitem "MLS Display 2025-05-02 23:36:06"
