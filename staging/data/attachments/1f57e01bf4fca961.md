...
Call log:
  - waiting for locator('#whatNowModal') to be visible
    43 × locator resolved to hidden <div id="whatNowModal" class="modal hide fade">…</div>
...
- group "Account Information":
  ...
  - textbox "Primary Email*": idxbqatest+1746627067530@gmail.com
  - text: Developer
  - combobox "Developer":
    - option "---" [selected]
    - option
  ...
  - text: Subdomain*
  - textbox "Subdomain*": qatest1746627067530
  - text: Custom Domain
  ...
  - text: Display Name*
  - textbox "Display Name*": QA Test Account 1746627098354
  - text: Street Address*
  ...
  - textbox "Fax"
  - text: Website*
  - textbox "Website*": https://qatest1746627067530.com
