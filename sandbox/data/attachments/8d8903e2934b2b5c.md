...
- Name: User: Client-Engage-1-Existing >> Save Social Settings - User: Client-Engage-1-Existing
- Location: /opt/atlassian/pipelines/agent/build/src/tests/specs/clients/06_design/04_settings/01_global/globalPreferences.spec.ts:47:13
...
Call log:
  - waiting for getByRole('link', { name: 'Social' })

    at GlobalPreferencesPage.navigateToSocialTab (/opt/atlassian/pipelines/agent/build/src/page-objects/client/06_design/04_settings/01_global/GlobalPreferencesPage.ts:99:30)
    at /opt/atlassian/pipelines/agent/build/src/tests/specs/clients/06_design/04_settings/01_global/globalPreferences.spec.ts:49:48
```
