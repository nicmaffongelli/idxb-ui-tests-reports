...
- article:
  ...
  - combobox "Select Market Area":
    - option
    - option "MLS Display 2025-05-02 22:51:08"
...
```ts
  ...
  402 |         const dropdownTrigger = this.page.getByTitle('Regional Multiple Listing');//getByRole('textbox', { name: 'Regional Multiple Listing Service' });
  403 |
