...
- Name: Type of user: Client >> MW Menu: Account >> Sub-menu: Users >> Sub-menu: Agents >> Delete All Agents - User: Client-Engage-1-Existing
- Location: /opt/atlassian/pipelines/agent/build/tests/specs/clients/account/users/agents.spec.ts:42:25
...
Call log:
  - waiting for getByRole('button', { name: 'Yes' })
    ...
    at ManageAgentsPage.deleteSelectedAgents (/opt/atlassian/pipelines/agent/build/tests/pages/client/account/users/ManageAgentsPage.ts:139:43)
