...
- Name: Type of user: Client >> MW Menu: Design >> Sub-menu: Settings >> Sub-menu: Global >> Sub-menu: Results >> Client can perform a search in Map Search FE page and the number of results is 100 - User: Client-Engage-1-Existing
