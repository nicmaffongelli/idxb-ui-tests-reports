...
Call log:
  - waiting for locator('div[style*="text-align:left"][style*="visibility:visible"]')
    ...
    at /opt/atlassian/pipelines/agent/build/tests/specs/frontEndPages/disclaimers.spec.ts:28:61
```
...
- article:
  ...
  - article:
    ...
    - link "More details of 3562 SE Harrison St":
      - /url: https://testing1210plat.idxstaging.com/idx/details/listing/a999/3978C1747240290909/3562-SE-Harrison-St-Portland-OR-97214-3978C1747240290909-Oregon
