...
Locator: locator('tr:has(td:text-is("idxqamv+1749097670515@gmail.com"))')
Expected: visible
Received: <element(s) not found>
Call log:
  - expect.toBeVisible with timeout 20000ms
  - waiting for locator('tr:has(td:text-is("idxqamv+1749097670515@gmail.com"))')
...
- grid:
  ...
  - combobox "Show entries":
    ...
    - option "100"
  - text: "entries Search:"
  - 'textbox "Search: ? "': idxqamv+1749097670515@gmail.com
  - link "?":
    - /url: "#"
  - link "":
    - /url: "#"
  ...
  - text: Showing 0 to 0 of 0 entries (filtered from 2 total entries)
  - list:
    - listitem:
      - link "← Previous":
        - /url: "#"
