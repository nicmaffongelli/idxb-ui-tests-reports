...
- Name: User: Client-Elite-1-Existing >> Client can perform a search in Basic Search FE page and the number of results is 25 - User: Client-Elite-1-Existing
...
Call log:
  - navigating to "https://testing1210elite.idxstaging.com/idx/search/basic", waiting until "load"
