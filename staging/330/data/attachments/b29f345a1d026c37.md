...
- Name: User: Client-Engage-1-Existing >> Client can perform a search in Basic Search FE page and the number of results is 25 - User: Client-Engage-1-Existing
...
Call log:
  - navigating to "https://testing1210plat.idxstaging.com/idx/search/basic", waiting until "load"
