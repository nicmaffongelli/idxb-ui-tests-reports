...
- Name: User: Client-Engage-1-Existing >> Save Your Properties Settings - User: Client-Engage-1-Existing
- Location: /opt/atlassian/pipelines/agent/build/src/tests/specs/clients/06_design/04_settings/01_global/globalPreferences.spec.ts:35:13
...
Call log:
  - waiting for getByRole('link', { name: 'Your Properties' })

    at GlobalPreferencesPage.navigateToPropertiesTab (/opt/atlassian/pipelines/agent/build/src/page-objects/client/06_design/04_settings/01_global/GlobalPreferencesPage.ts:92:34)
    at /opt/atlassian/pipelines/agent/build/src/tests/specs/clients/06_design/04_settings/01_global/globalPreferences.spec.ts:37:48
```
