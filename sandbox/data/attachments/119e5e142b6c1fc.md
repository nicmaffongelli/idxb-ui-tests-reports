...
- Name: User: Client-Engage-1-Existing >> Save Results Settings - User: Client-Engage-1-Existing
- Location: /opt/atlassian/pipelines/agent/build/src/tests/specs/clients/06_design/04_settings/01_global/globalPreferences.spec.ts:17:13
...
Call log:
  - waiting for getByRole('link', { name: 'Results' })

    at GlobalPreferencesPage.navigateToResultsTab (/opt/atlassian/pipelines/agent/build/src/page-objects/client/06_design/04_settings/01_global/GlobalPreferencesPage.ts:85:31)
    at /opt/atlassian/pipelines/agent/build/src/tests/specs/clients/06_design/04_settings/01_global/globalPreferences.spec.ts:19:48
```
