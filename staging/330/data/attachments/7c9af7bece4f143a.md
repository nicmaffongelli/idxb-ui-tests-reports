...
- Name: User: Client-Engage-1-Existing >> Client can perform a search in Map Search FE page and the number of results is 100 - User: Client-Engage-1-Existing
...
Call log:
  - navigating to "https://testing1210plat.idxstaging.com/idx/map/mapsearch", waiting until "load"
