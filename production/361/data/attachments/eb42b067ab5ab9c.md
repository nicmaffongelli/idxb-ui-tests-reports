...
- Location: /opt/atlassian/pipelines/agent/build/src/tests/specs/clients/07_account/04_users/agents.spec.ts:18:13
...
Locator: locator('tr:has(td:text-is("idxqamv+1749097698957@gmail.com"))')
Expected: visible
Received: <element(s) not found>
Call log:
  - expect.toBeVisible with timeout 20000ms
  - waiting for locator('tr:has(td:text-is("idxqamv+1749097698957@gmail.com"))')
    ...
    at /opt/atlassian/pipelines/agent/build/src/tests/specs/clients/07_account/04_users/agents.spec.ts:29:13
```
...
- grid:
  ...
  - combobox "Show entries":
    ...
    - option "100"
  - text: "entries Search:"
  - 'textbox "Search: ? "': idxqamv+1749097698957@gmail.com
  - link "?":
    - /url: "#"
  - link "":
    - /url: "#"
