...
- Name: Type of user: Client >> MW Menu: Design >> Sub-menu: Settings >> Sub-menu: Locations >> Edit County List, Verify in FE, and Revert
- Location: /opt/atlassian/pipelines/agent/build/tests/specs/clients/design/settings/locations/createNewLocationList.spec.ts:97:21
...
Call log:
  - waiting for locator('#currentList').getByRole('checkbox', { name: 'Adams, WA' })
    ...
    at /opt/atlassian/pipelines/agent/build/tests/specs/clients/design/settings/locations/createNewLocationList.spec.ts:108:58
```
