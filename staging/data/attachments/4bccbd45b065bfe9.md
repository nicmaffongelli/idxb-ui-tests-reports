...
Call log:
  - waiting for locator('#whatNowModal') to be visible
    42 × locator resolved to hidden <div id="whatNowModal" class="modal hide fade">…</div>
...
- group "Account Information":
  ...
  - textbox "Primary Email*": idxbqatest+1746627136027@gmail.com
  - text: Developer
  - combobox "Developer":
    - option "---" [selected]
    - option
  ...
  - text: Subdomain*
  - textbox "Subdomain*": qatest1746627136027
  - text: Custom Domain
  ...
  - text: Display Name*
  - textbox "Display Name*": QA Test Account 1746627214957
  - text: Street Address*
  ...
  - textbox "Fax"
  - text: Website*
  - textbox "Website*": https://qatest1746627136027.com
  ...
  - paragraph: Attempted to create account '4580', but an issue prevented it from being created. Please create a new ticket for this issue, and include any error messages that display below.',
  - paragraph: "SQLSTATE[23000]: Integrity constraint violation: 1062 Duplicate entry 'client-4580' for key 'info.clientParter' (SQL: insert into `info` (`clientPartner`, `setupFeeCouponCode`, `accountID`, `level`) values (client, ?, 4580, 20))"
  - button "Create"
  - button "Reset"
- paragraph:
  - text: Services © 2025
