...
- Location: /opt/atlassian/pipelines/agent/build/src/tests/specs/superUser/mls/data/mlsDataExplorer.spec.ts:9:21
...
Call log:
  ...
  - attempting select option action
    ...
    at MlsDataExplorerPage.runPropertyQuery (/opt/atlassian/pipelines/agent/build/src/page-objects/superUser/mls/data/MlsDataExplorerPage.ts:53:33)
    at /opt/atlassian/pipelines/agent/build/src/tests/specs/superUser/mls/data/mlsDataExplorer.spec.ts:15:57
```
...
```ts
   ...
   2 | import { BasePage } from '../../../base-page/BasePage';
   3 |
