...
Locator: locator('tr:has(td:text-is("idxqamv+2392d4b4-a7af-4a56-84d9-cf556d03f466@gmail.com"))')
Expected: visible
Received: <element(s) not found>
Call log:
  - expect.toBeVisible with timeout 20000ms
  - waiting for locator('tr:has(td:text-is("idxqamv+2392d4b4-a7af-4a56-84d9-cf556d03f466@gmail.com"))')

    at ManageAgentsPage.verifyAgentExistsByEmail (/opt/atlassian/pipelines/agent/build/tests/pages/client/account/users/ManageAgentsPage.ts:127:32)
    at /opt/atlassian/pipelines/agent/build/tests/specs/clients/account/users/agents.spec.ts:35:25
```
...
- grid:
  ...
  - combobox "Show entries":
    ...
    - option "100"
  - text: "entries Search:"
  - 'textbox "Search: ? "': idxqamv+2392d4b4-a7af-4a56-84d9-cf556d03f466@gmail.com
  - link "?":
    - /url: "#"
  - link "":
    - /url: "#"
