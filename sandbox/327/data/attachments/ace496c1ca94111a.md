...
- Name: Type of user: Client >> MW Menu: Design >> Sub-menu: Settings >> Sub-menu: Global >> Sub-menu: Results >> Client can perform a search in Basic Search FE page and the number of results is 25 - User: Client-Core-1-Existing
