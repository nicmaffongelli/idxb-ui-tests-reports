...
Error: expect(Buffer).toMatchSnapshot(expected)
  ...
  1795 pixels (ratio 0.01 of all image pixels) are different.

Expected: /opt/atlassian/pipelines/agent/build/tests/specs/clients/design/branding/brandingColors.spec.ts-snapshots/staging-advanced-search-Chrome-linux.png
Received: /opt/atlassian/pipelines/agent/build/test-results/specs-clients-design-brand-8a050----Client-Client-Engage-New-Chrome/staging-advanced-search-actual.png
    Diff: /opt/atlassian/pipelines/agent/build/test-results/specs-clients-design-brand-8a050----Client-Client-Engage-New-Chrome/staging-advanced-search-diff.png
...
- navigation:
  - link "Advanced Search":
    - /url: https://qatest1746660571105.idxstaging.com/idx/search/advanced
  - link "Listing ID":
    - /url: https://qatest1746660571105.idxstaging.com/idx/search/listingid
  - link "Address":
    - /url: https://qatest1746660571105.idxstaging.com/idx/search/address
  - link "AI Smart Search":
    - /url: https://qatest1746660571105.idxstaging.com/idx/search/smart
  - link "Map Search":
    - /url: https://qatest1746660571105.idxstaging.com/idx/map/mapsearch
  - separator
- text: Location
- textbox "Location"
- combobox:
