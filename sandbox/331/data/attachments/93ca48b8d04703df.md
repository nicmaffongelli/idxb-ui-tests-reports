...
Call log:
  ...
  - attempting click action
    2 × waiting for element to be visible, enabled and stable
      ...
      - done scrolling
      - <button type="submit" data-theme="b" id="IDX-submitBtn" class="IDX-btn IDX-btn-primary">Sign Up!</button> from <div tabindex="-1" role="dialog" aria-labelledby="ui-dialog-title-IDX-registration" class="ui-dialog ui-widget ui-widget-content ui-corner-all IDX-registrationModal IDX-registration-requestRecurring">…</div> subtree intercepts pointer events
...
- banner "Main Header":
  - navigation "Main Navigation":
    - menubar:
      - menuitem "Regression1210Elite":
        - img
        - text: Regression1210Elite
  - navigation "Secondary Navigation":
    - menubar:
      - menuitem "Go to Home Page":
        - link "Go to Home Page":
          - /url: /home
          - text: Home
      - menuitem "Learn About Us":
        - link "Learn About Us":
          - /url: /about
          - text: About
      - menuitem "Search Listings on Map":
        - link "Search Listings on Map":
          - /url: /idx/map/mapsearch
          - text: Search
  - link "Call Us":
    - /url: tel:1001001000
    - text: "1001001000"
...
- contentinfo "Website Footer":
  ...
  - paragraph:
    - link "1001001000":
      - /url: tel:1001001000
  - paragraph:
    - link "nicolas.maffongelli+Regression1210Elite@gmail.com":
      - /url: mailto:nicolas.maffongelli+Regression1210Elite@gmail.com
  - link "Go to Home Page":
    - /url: /home
    - text: Home
  - link "Learn About Us":
  ...
  - link "Search Properties":
    - /url: /idx/map/mapsearch
    - text: Search
  - paragraph: ©2025 IDX Broker. All Rights Reserved
