...
Error: expect(Buffer).toMatchSnapshot(expected)
  ...
  7871 pixels (ratio 0.09 of all image pixels) are different.

Expected: /opt/atlassian/pipelines/agent/build/tests/specs/clients/design/branding/brandingColors.spec.ts-snapshots/production-navigation-bar-Chrome-linux.png
Received: /opt/atlassian/pipelines/agent/build/test-results/specs-clients-design-brand-8a050----Client-Client-Engage-New-Chrome/production-navigation-bar-actual.png
    Diff: /opt/atlassian/pipelines/agent/build/test-results/specs-clients-design-brand-8a050----Client-Client-Engage-New-Chrome/production-navigation-bar-diff.png

    at /opt/atlassian/pipelines/agent/build/tests/specs/clients/design/branding/brandingColors.spec.ts:38:60
```
...
- navigation:
  - link "Advanced Search":
    - /url: https://qatest1746744371448.idxbroker.com/idx/search/advanced
  - link "Listing ID":
    - /url: https://qatest1746744371448.idxbroker.com/idx/search/listingid
  - link "Address":
    - /url: https://qatest1746744371448.idxbroker.com/idx/search/address
  - link "AI Smart Search":
    - /url: https://qatest1746744371448.idxbroker.com/idx/search/smart
  - link "Map Search":
    - /url: https://qatest1746744371448.idxbroker.com/idx/map/mapsearch
  - separator
- text: Location
- textbox "Location"
- combobox:
