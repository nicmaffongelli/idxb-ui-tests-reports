...
Call log:
  - waiting for getByTitle('MLS Display 2025-05-27 04:06:05')

    at FrontEndAdvancedSearchPage.selectMlsByDisplayName (/opt/atlassian/pipelines/agent/build/tests/pages/client/frontEndPages/FrontEndAdvancedSearchPage.ts:129:31)
    at /opt/atlassian/pipelines/agent/build/tests/specs/clients/design/settings/mls/mlsGlobalSettings.spec.ts:39:65
```
...
```ts
   29 |     readonly cczInputField: Locator;
   30 |     
   31 |     // Price elements
   32 |     readonly clearMinPriceField: Locator;
   33 |     readonly clearMaxPriceField: Locator;
   34 |
   35 |     // Property Type elements
   36 |     readonly propertyTypeDropdown: Locator;
   37 |     
