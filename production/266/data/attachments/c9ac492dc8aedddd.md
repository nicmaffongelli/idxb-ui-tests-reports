...
Call log:
  - waiting for locator('.select2-container--open .select2-results__options[role="listbox"]').getByRole('option', { name: 'MLS Display 2025-05-09 23:11:41' })
...
- navigation:
  ...
  - separator
- text: Location
- combobox "MLS Display 2025-05-09 23:11:41" [expanded]:
  - text: MLS Display 2025-05-09 23:11:41
  - tree:
    - treeitem "MLS Display 2025-05-09 23:11:41" [selected]
...
```ts
   ...
   83 |         this.propertyTypeDropdown = page.locator('#select2-IDX-pt-container');
   84 |         
