...
Locator: locator('#IDX-map')
Expected: visible
Received: <element(s) not found>
Call log:
  - expect.toBeVisible with timeout 20000ms
  - waiting for locator('#IDX-map')

    at FrontEndMapSearchPage.verifyPinClustersVisible (/opt/atlassian/pipelines/agent/build/tests/pages/client/frontEndPages/FrontEndMapSearchPage.ts:59:32)
    at /opt/atlassian/pipelines/agent/build/tests/specs/clients/design/settings/mapGlobalPreferences.spec.ts:40:77
```
...
```ts
   ...
   11 |
   12 |   // Results page elements
   13 |   readonly listingCardImageOverlays: Locator;
   14 |   readonly totalResultsCount: Locator;
   15 |   
   16 |   // Filter elements
   17 |   private readonly minPriceInput: Locator;
