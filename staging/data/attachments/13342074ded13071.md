...
- Name: Run these test in serial mode for each user >> Delete All Agents - User: Client-Engage-1-Existing
- Location: /opt/atlassian/pipelines/agent/build/src/tests/specs/clients/07_account/04_users/agents.spec.ts:37:13
...
Call log:
  - waiting for getByRole('button', { name: 'Yes' })
    ...
    at ManageAgentsPage.deleteSelectedAgents (/opt/atlassian/pipelines/agent/build/src/page-objects/client/07_account/04_users/ManageAgentsPage.ts:97:43)
    at /opt/atlassian/pipelines/agent/build/src/tests/specs/clients/07_account/04_users/agents.spec.ts:54:13
```
