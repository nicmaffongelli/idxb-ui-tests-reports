...
Locator: locator('tr:has(td:text-is("idxqamv+1c406162-c0c8-462f-8635-f299cc3db44e@gmail.com"))')
Expected: visible
Received: <element(s) not found>
Call log:
  - expect.toBeVisible with timeout 20000ms
  - waiting for locator('tr:has(td:text-is("idxqamv+1c406162-c0c8-462f-8635-f299cc3db44e@gmail.com"))')
    ...
    at /opt/atlassian/pipelines/agent/build/tests/specs/clients/account/users/agents.spec.ts:34:25
```
...
- grid:
  ...
  - combobox "Show entries":
    ...
    - option "100"
  - text: "entries Search:"
  - 'textbox "Search: ? "': idxqamv+1c406162-c0c8-462f-8635-f299cc3db44e@gmail.com
  - link "?":
    - /url: "#"
  - link "":
    - /url: "#"
...
>  97 |         await expect(agentRow).toBeVisible();
  ...
  148 |         // Wait for the jGrowl notification to appear
  149 |         //await this.successMessage.waitFor({ state: 'visible' });
  150 |         
  151 |         // Verify the text matches what we expect
  152 |         await expect(this.successMessage).toContainText('All Agents you selected have been deleted.');
  153 |     }
  154 |     
  155 | }
```