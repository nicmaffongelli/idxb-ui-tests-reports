...
Error: expect(Buffer).toMatchSnapshot(expected)
  ...
  1660 pixels (ratio 0.02 of all image pixels) are different.

Expected: /opt/atlassian/pipelines/agent/build/tests/specs/clients/design/branding/brandingColors.spec.ts-snapshots/sandbox-navigation-bar-Chrome-linux.png
Received: /opt/atlassian/pipelines/agent/build/test-results/specs-clients-design-brand-8a050----Client-Client-Engage-New-Chrome-retry1/sandbox-navigation-bar-actual.png
    Diff: /opt/atlassian/pipelines/agent/build/test-results/specs-clients-design-brand-8a050----Client-Client-Engage-New-Chrome-retry1/sandbox-navigation-bar-diff.png
...
- navigation:
  - link "Advanced Search":
    - /url: https://qatest1746742383588.idxsandbox.com/idx/search/advanced
  - link "Listing ID":
    - /url: https://qatest1746742383588.idxsandbox.com/idx/search/listingid
  - link "Address":
    - /url: https://qatest1746742383588.idxsandbox.com/idx/search/address
  - link "AI Smart Search":
    - /url: https://qatest1746742383588.idxsandbox.com/idx/search/smart
  - link "Map Search":
    - /url: https://qatest1746742383588.idxsandbox.com/idx/map/mapsearch
  - separator
- text: Location
- textbox "Location"
- combobox:
