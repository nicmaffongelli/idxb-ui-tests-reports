...
- Name: Branding Colors Test - Client-Engage-New >> Client can modify and save branding colors. Branding colors are displayed as expected in FE search page - Client: Client-Engage-New
- Location: /opt/atlassian/pipelines/agent/build/src/tests/specs/clients/06_design/01_branding/brandingColors.spec.ts:10:13
...
Call log:
  - navigating to "https://qatest1748369936042.idxstaging.com/idx/search/address", waiting until "load"
    ...
    at /opt/atlassian/pipelines/agent/build/src/tests/specs/clients/06_design/01_branding/brandingColors.spec.ts:22:52
```
